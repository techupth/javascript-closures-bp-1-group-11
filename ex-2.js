...
const addByTwo = matchAction(2);
console.log(addByTwo.addByX(1)); // Output: 3
console.log(addByTwo.addByX(2)); // Output: 4
console.log(addByTwo.addByX(3)); // Output: 5
...
const subtractByThree = matchAction(3);
console.log(subtractByThree.subtractByX(4)); // Output: 1
console.log(subtractByThree.subtractByX(6)); // Output: 3
console.log(subtractByThree.subtractByX(8)); // Output: 5